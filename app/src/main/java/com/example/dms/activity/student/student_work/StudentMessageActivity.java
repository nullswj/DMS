...
import com.example.dms.activity.teacher.TeacherMsgInfoActivity;
...
public class StudentMessageActivity extends BaseActivity implements   AdapterView.OnItemClickListener, AbsListView.OnScrollListener{

    private Toolbar tlb_student_message;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.student_message_toolbar, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case android.R.id.home:
                finish();
                break;
            case R.id.student_message_clear:
...
//                this.findViewById(R.id.deviceLine).setVisibility(View.GONE);
    ...
    {
        tlb_student_message = findViewById(R.id.tlb_student_message);
        setSupportActionBar(tlb_student_message);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1.获取设备Token
        Handler handler = new StudentMessageActivity.HandlerExtension(StudentMessageActivity.this);
...
//        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int index, long id) {
        Intent ait = new Intent(this,StudentMsgInfoActivity.class);
...
//            this.findViewById(R.id.deviceLine).setVisibility(View.GONE);
    ...
    private static class HandlerExtension extends Handler {
        WeakReference<StudentMessageActivity> mActivity;

        HandlerExtension(StudentMessageActivity activity) {
            mActivity = new WeakReference<StudentMessageActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            StudentMessageActivity theActivity = mActivity.get();
            if (theActivity == null) {
                theActivity = new StudentMessageActivity();
            }
            if (msg != null) {
