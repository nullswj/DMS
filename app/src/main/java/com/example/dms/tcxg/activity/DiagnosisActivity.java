...
import com.example.dms.tcxg.bean.ClickAction;
import com.example.dms.tcxg.bean.Style;
import com.example.dms.tcxg.bean.TimeInterval;
import com.example.dms.tcxg.common.CommonWorkingThread;
import com.example.dms.tcxg.common.ExtendedListView;
import com.example.dms.tcxg.common.XingeApp;
...
public class DiagnosisActivity extends BaseActivity implements ExtendedListView.OnPositionChangedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tcxg_activity_diagnosis);
    ...
    private class DummyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(DiagnosisActivity.this).inflate(R.layout.tcxg_list_item, parent,
                        false);
            }
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            com.example.dms.tcxg.bean.Message message = new com.example.dms.tcxg.bean.Message();
            message.setType(com.example.dms.tcxg.bean.Message.TYPE_NOTIFICATION);
